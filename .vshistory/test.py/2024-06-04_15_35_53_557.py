...
def test_tl2cgen(n):
    ...
    for i in range(n):
        ...
        print(out_pred_tl2cgen)

def test_tl(n):
    model.export_lib(toolchain=toolchain, libpath='./mymodel.dll', verbose=True)
    predictor_tl = treelite_runtime.Predictor('./mymodel.dll', verbose=True)
